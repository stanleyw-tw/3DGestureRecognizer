	...
	private ArrayList<Gesture> getGesturesByID(String gestureID)
	{
		...
		if (myDB != null)
		{
			...
			if (c!= null )
			{
				...
				Log.d("getGesturesByID","gestureTraceColumn="+gestureTraceColumn);
				Log.d("getGesturesByID","dateAddedColumn="+dateAddedColumn);
				Log.d("getGesturesByID","dbIDColumn="+dbIDColumn);
